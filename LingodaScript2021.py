...
parser.add_argument('-lang', '--language', type=str, default="german", help="Language to process. It shuold be the name of the folder in 'webpages'")
parser.add_argument('-l','--levels', nargs='+', help='List of levels to process (separated by space)',  
